<?php
//
// File generated by ... on the 2015-12-23T14:54:51+0100
...
class ApplicationRole extends SecurityRole
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("conflictingrole_list", array("linked_class"=>'lnkApplicationRoleToSecurityRole', "ext_key_to_me"=>'applicationrole_id', "ext_key_to_remote"=>'securityrole_id', "allowed_values"=>null, "count_min"=>0, "count_max"=>0, "duplicates"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class BusinessRole extends SecurityRole
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("conflictingrole_list", array("linked_class"=>'lnkBusinessRoleToSecurityRole', "ext_key_to_me"=>'businessrole_id', "ext_key_to_remote"=>'securityrole_id', "allowed_values"=>null, "count_min"=>0, "count_max"=>0, "duplicates"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class lnkBusinessRoleToSecurityRole extends cmdbAbstractObject
{
	public static function Init()
	{
		$aParams = array
		(
			...
			'key_type' => 'autoincrement',
			'is_link' => true,
			'name_attcode' => array('securityrole_id', 'businessrole_id'),
			'state_attcode' => '',
			'reconc_keys' => array('securityrole_id', 'businessrole_id'),
			'db_table' => 'lnkbusinessroletosecurityrole',
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
		);
		MetaModel::Init_Params($aParams);
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("securityrole_id", array("targetclass"=>'SecurityRole', "allowed_values"=>null, "sql"=>'securityrole_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_AUTO, "depends_on"=>array(), "display_style"=>'select', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("securityrole_name", array("allowed_values"=>null, "extkey_attcode"=>'securityrole_id', "target_attcode"=>'name', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("businessrole_id", array("targetclass"=>'BusinessRole', "allowed_values"=>null, "sql"=>'businessrole_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_AUTO, "depends_on"=>array(), "display_style"=>'select', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("businessrole_name", array("allowed_values"=>null, "extkey_attcode"=>'businessrole_id', "target_attcode"=>'name', "always_load_in_tables"=>false)));
...
class lnkApplicationRoleToSecurityRole extends cmdbAbstractObject
{
	public static function Init()
	{
		$aParams = array
		(
			...
			'key_type' => 'autoincrement',
			'is_link' => true,
			'name_attcode' => array('securityrole_id', 'applicationrole_id'),
			'state_attcode' => '',
			'reconc_keys' => array('securityrole_id', 'applicationrole_id'),
			'db_table' => 'lnkapplicationroletosecurityrole',
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
		);
		MetaModel::Init_Params($aParams);
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("securityrole_id", array("targetclass"=>'SecurityRole', "allowed_values"=>null, "sql"=>'securityrole_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_AUTO, "depends_on"=>array(), "display_style"=>'select', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("securityrole_name", array("allowed_values"=>null, "extkey_attcode"=>'securityrole_id', "target_attcode"=>'name', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("applicationrole_id", array("targetclass"=>'ApplicationRole', "allowed_values"=>null, "sql"=>'applicationrole_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_AUTO, "depends_on"=>array(), "display_style"=>'select', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("applicationrole_name", array("allowed_values"=>null, "extkey_attcode"=>'applicationrole_id', "target_attcode"=>'name', "always_load_in_tables"=>false)));



		MetaModel::Init_SetZListItems('details', array (
  0 => 'securityrole_id',
  1 => 'applicationrole_id',
));
		MetaModel::Init_SetZListItems('standard_search', array (
  0 => 'securityrole_id',
  1 => 'applicationrole_id',
...
class MenuCreation_esguardian_security_mgmt extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['SearchRole'] = new SearchMenuNode('SearchRole', 'SecurityRole', $__comp_menus__['ConfigManagement']->GetIndex(), 10);
	}
